...
class _ClientsPageState extends State<ClientsPage> {
          ...
          itemBuilder: (context, index) {
            return Dismissible(
              ...
              child: ListTile(
                ...
                title: Text(listClients.clients[index].name +
                    ' (' +
                    listClients.clients[index].type.name +
                    ')'),
                iconColor: Colors.indigo,
              ),
              onDismissed: (direction) {
                setState(() {
                  listClients.clients.removeAt(index);
                });
              },
            );
          },
  ...
  void createType(context) {
    ...
    ClientsTypes listTypes = Provider.of<ClientsTypes>(context, listen: false);
